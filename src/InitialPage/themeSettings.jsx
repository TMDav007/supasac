                ...
                >
                  <div className="accordion-body pb-1 px-0 py-3 border-top">
                    ...
                    <div className="d-flex align-items-center flex-wrap">
                      ...
                      <div
                        className={`theme-colorselect box-style position-relative theme-colorselect-rounded mb-3 mt-0 ${dataTopBar === 'all' ? 'active' : ''}`}
                ...
                >
                  <div className="accordion-body px-0 py-3 border-top">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div
                        className={`theme-colorselect oval-style position-relative m-1 mt-0 ${dataSidebar === 'all' ? 'active' : ''}`}
